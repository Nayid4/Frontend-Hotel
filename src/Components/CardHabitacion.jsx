        ...
        >
            ...
            <Box sx={{flexGrow: 1, display: "grid", gap: 1}}>
                ...
                <Typography variant="p">
                    ...
                    </Icon>   {bed.capacidad} Personas
                </Typography>
                
                <Typography variant="p" color="primary">{bed.caracteristicas.join(" - ")}</Typography>
                
                <Typography variant="body1">{bed.descripcion}</Typography>
                <Button variant="contained" onClick={handleClick}>Reservar</Button>
